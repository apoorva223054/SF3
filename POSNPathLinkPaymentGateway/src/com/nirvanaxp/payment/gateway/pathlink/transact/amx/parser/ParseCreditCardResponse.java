 ...
 **/
package com.nirvanaxp.payment.gateway.pathlink.transact.amx.parser;

import com.nirvanaxp.payment.gateway.pathlink.service.Util;
...
public class ParseCreditCardResponse
{
	...
	public PaymentGatewayPathLinkResponse Parse(String responseXmlStr)
	{

		PaymentGatewayPathLinkResponse response = new PaymentGatewayPathLinkResponse();
