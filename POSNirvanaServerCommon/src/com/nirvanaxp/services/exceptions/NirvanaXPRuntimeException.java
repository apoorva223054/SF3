...
public class NirvanaXPRuntimeException extends RuntimeException
{
	...
	public NirvanaXPRuntimeException(Throwable t)
	{
		super(t);
	}
	...
	public NirvanaXPRuntimeException(NirvanaServiceErrorResponse response)
	{
		super();
