...
@XmlRootElement(name = "ItemsAttributePacket")
public class ItemsAttributePacket extends PostPacket
{

	private ItemsAttribute ItemsAttribute;
	...
	public ItemsAttribute getItemsAttribute()
	{
		return ItemsAttribute;
	}

	public void setItemsAttribute(ItemsAttribute itemsAttribute)
	{
	...
	{
		return "ItemsAttributePacket [ItemsAttribute=" + ItemsAttribute + ", isBaseLocationUpdate=" + isBaseLocationUpdate + "]";
	}
