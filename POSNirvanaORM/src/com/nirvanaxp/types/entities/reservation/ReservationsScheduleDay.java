...
/**
 * The persistent class for the reservation_schedule_days database table.
 * 
 */
@Entity
@Table(name = "reservations_schedule_days")
@XmlRootElement(name = "reservations_schedule_days")
public class ReservationsScheduleDay implements Serializable
{
	...
	public ReservationsScheduleDay()
	{
	}
	...
	public String toString() {
		return "ReservationsScheduleDay [id=" + id + ", created=" + created
				+ ", createdBy=" + createdBy + ", daysId=" + daysId
				+ ", status=" + status + ", reservationsScheduleId="
				+ reservationsScheduleId + ", updated=" + updated
				+ ", updatedBy=" + updatedBy + "]";
	}
