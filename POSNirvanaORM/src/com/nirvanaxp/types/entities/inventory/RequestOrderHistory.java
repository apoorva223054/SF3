...
@Entity
@Table(name = "request_order_history")
@XmlRootElement(name = "request_order_history")
public class RequestOrderHistory extends POSNirvanaBaseClassWithBigIntWithGeneratedId
{
   ...
   @Column(name = "grn_count")
	...
	transient List<RequestOrderDetailItemsHistory> requestOrderDetailItemsHistories;
	...
	public String getRequestOrderId() {
		 if(requestOrderId != null && (requestOrderId.length()==0 || requestOrderId.equals("0"))){return null;}else{	return requestOrderId;}
	}
	...
	public List<RequestOrderDetailItemsHistory> getRequestOrderDetailItemsHistories() {
		return requestOrderDetailItemsHistories;
	}

	public void setRequestOrderDetailItemsHistories(List<RequestOrderDetailItemsHistory> requestOrderDetailItemsHistories) {
		this.requestOrderDetailItemsHistories = requestOrderDetailItemsHistories;
	}
	...
	public String toString() {
		return "RequestOrderHistory [locationId=" + locationId + ", name=" + name + ", supplierId=" + supplierId
				+ ", purchaseOrderId=" + purchaseOrderId + ", requestOrderId=" + requestOrderId + ", date=" + date
				+ ", statusId=" + statusId + ", isPOOrder=" + isPOOrder + ", isDirectRequestAllocation="
				+ isDirectRequestAllocation + ", grnCount=" + grnCount + ", priceTax1=" + priceTax1 + ", priceTax2="
				+ priceTax2 + ", priceTax3=" + priceTax3 + ", priceTax4=" + priceTax4 + ", taxName1=" + taxName1
				+ ", taxName2=" + taxName2 + ", taxName3=" + taxName3 + ", taxName4=" + taxName4 + ", taxDisplayName1="
				+ taxDisplayName1 + ", taxDisplayName2=" + taxDisplayName2 + ", taxDisplayName3=" + taxDisplayName3
				+ ", taxDisplayName4=" + taxDisplayName4 + ", taxRate1=" + taxRate1 + ", taxRate2=" + taxRate2
				+ ", taxRate3=" + taxRate3 + ", taxRate4=" + taxRate4 +  ", localTime=" + localTime +"]";
	}
