...
/**
 * The persistent class for the locations_type database table.
 * 
 */
@Entity
@Table(name = "locations_type")
@XmlRootElement(name = "locations_type")
public class LocationsType implements Serializable
{
	...
	public String toString() {
		return "LocationsType [id=" + id + ", created=" + created
				+ ", createdBy=" + createdBy + ", name=" + name + ", updated="
