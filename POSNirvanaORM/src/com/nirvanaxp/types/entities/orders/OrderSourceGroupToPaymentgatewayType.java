...
/**
 * The persistent class for the order_source_group_to_paymentgateway_type
 * database table.
 * 
 */
@Entity
@Table(name = "order_source_group_to_paymentgateway_type")
@XmlRootElement(name = "order_source_group_to_paymentgateway_type")
public class OrderSourceGroupToPaymentgatewayType implements Serializable
{
	...
	public OrderSourceGroupToPaymentgatewayType()
	{
	}
	...
	{
		return "OrderSourceGroupToPaymentgatewayType [id=" + id + ", created=" + created + ", createdBy=" + createdBy + ", merchantId=" + merchantId + ", orderSourceGroupId=" + orderSourceGroupId
				+ ", parameter1=" + parameter1 + ", parameter2=" + parameter2 + ", parameter3=" + parameter3 + ", parameter4=" + parameter4 + ", parameter5=" + parameter5 + ", password=" + password
				+ ", status=" + status + ", paymentgatewayTypeId=" + paymentgatewayTypeId + ", updated=" + updated + ", updatedBy=" + updatedBy + "]";
	}
