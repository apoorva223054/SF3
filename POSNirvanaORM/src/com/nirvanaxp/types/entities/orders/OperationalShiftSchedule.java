...
@Entity
@Table(name = "operational_shift_schedule")
@XmlRootElement(name = "operational_shift_schedule")
public class OperationalShiftSchedule implements Serializable
{
	...
	public OperationalShiftSchedule()
	{
	}

	public OperationalShiftSchedule(Object[] obj)
	{
	...
	{
		return "OperationalShiftSchedule [id=" + id + ", shiftName=" + shiftName + ", fromTime=" + fromTime + ", toTime=" + toTime + ", fromDate=" + fromDate + ", toDate=" + toDate + ", locationId="
				+ locationId + ", slotTime=" + slotTime + ", maxOrderAllowed=" + maxOrderAllowed + ", holdTime=" + holdTime + ", status=" + status + ", created=" + created + ", createdBy="
