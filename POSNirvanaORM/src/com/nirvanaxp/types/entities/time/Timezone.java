...
public class Timezone implements Serializable
{
	...
	@Column(name = "timezone_name", nullable = false, length = 128)
	...
	public String toString() {
		return "Timezone [id=" + id + ", created=" + created + ", createdBy="
				+ createdBy + ", displayName=" + displayName
				+ ", displaySequence=" + displaySequence + ", timezoneName="
				+ timezoneName + ", updated=" + updated + ", updatedBy="
				+ updatedBy + "]";
	}
